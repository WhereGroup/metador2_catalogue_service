...
```bash
git clone git@repo.wheregroup.com:metador2/csw.git src/Plugins/WhereGroup/CatalogueServiceBundle; bin/console metador:enable:plugin metador_catalogue_service
```
